            ...
            <div>
                @if ($effectifs->count() > 0)
                    ...
                    <div class="flex justify-center">
                        <table class="table-auto shadow-lg bg-white rounded-lg mt-5">
                            <thead>
                                <tr>
                                    <th class="bg-purple-300 border text-1xl px-6 py-4">PRENOM</th>
                                    <th class="bg-purple-300 border px-6 py-4">NOM</th>
                                    <th class="bg-purple-300 border px-3 py-4">DATE DE NAISSANCE</th>
                                    <th class="bg-purple-300 border px-3 py-4">LIEU DE NAISSANCE</th>
                                    <th class="bg-purple-300 border px-6 py-4">NATIONALITE</th>
                                    <th class="bg-purple-300 border px-10 py-4">CLUB</th>
                                    <th class="bg-purple-300 border px-3 py-4">NUMERO</th>
                                    <th class="bg-purple-300 border px-6 py-4">ACTION</th>
                                </tr>
                            </thead>
                            <tbody>
                                @foreach ($effectifs as $effectif)
                                    <tr>
                                        <td class="border px-6 py-2">{{ $effectif->prenom }}</td>
                                        <td class="border px-6 py-2">{{ $effectif->nom }}</td>
                                        <td class="border py-2 text-center">{{ $effectif->datenaissance }}</td>
                                        <td class="border py-2 text-center">{{ $effectif->lieunaissance }}</td>
                                        <td class="border px-6 py-2 text-center">{{ $effectif->nationalite }}</td>
                                        <td class="border px-10 py-2">{{ $effectif->club }}</td>
                                        <td class="border py-2 text-center">{{ $effectif->numero }}</td>
                                        <td class="border px-6 py-2 text-center">
                                            ...
                                            <a href="{{route('pageTransfertJoueur',$effectif->id)}}">
                                                <svg version="1.1" height="20" width="30" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                @else
                    <span class="mt-12 flex justify-center text-2xl text-purple-900">Aucun joueur en base de donnée</span>
                @endif
            </div>
        </div>
    </div>
