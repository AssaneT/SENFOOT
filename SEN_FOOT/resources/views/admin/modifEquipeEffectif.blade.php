        ...
        <div class="box-border h-80 w-full bg-gray-800">
            ...
            <div class="w-full h-52">
                <div class="flex justify-center">
                    <img class="object-left object-contain w-36 h-36 shadow-lg rounded-full max-w-full h-auto align-middle border-none mt-3" src="http://localhost/SEN_FOOT/storage/app/public/{{ $equipes->logo }}">
                </div>
