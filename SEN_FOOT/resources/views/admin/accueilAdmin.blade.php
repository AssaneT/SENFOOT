...
<body class="bg-gray-800 font-sans leading-normal tracking-normal mt-12">
            ...
            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    <li class="mr-3 flex-1">
                        <a href="{{ route('pageAccueilAdmin') }}" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                                                        ...
                                                        @if ($i == $classement->position)
                                                            @if ($classement->id_championnat == $championnat->id)
                                                                <tr>
                                                                    ...
                                                                    <td class="uppercase">{{ $classement->equipe }}</td>
      ...
      <div class="container max-w-5xl mx-auto m-2">
          <div class="text-center">
            <p class="text-center text-gray-600">
                Gerez toutes les championnats du monde en temps réel
              <br />
              <br />
            </p>
          </div>
        ...
        <div class="flex justify-center">
          <div class="w-full sm:w-1/2 p-6">
            <svg class="flex flex-row w-5/6 sm:h-64 mx-auto" viewBox="0 0 1176.60617 873.97852" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Ici pour la passion, ici pour rester!
      </h3>
    </section>
